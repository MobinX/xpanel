...
export const BgWrapper = ({ children }: { children: ReactNode }) => {
    return (
        <div className="w-full h-full  flex flex-col justify-center items-center relative bg-base-100 text-base-content">
            <div className="w-full h-full absolute z-50 inset-0  flex justify-center items-center text-base-content overflow-auto" style={{ backdropFilter: "blur(290px) brightness(0.6)" , animation: "fadeIntoFadeOut 5s infinite"}}>
                {children} </div>
